  ...
  return (
    <footer className="site-footer relative isolate min-h-[760px] bg-paper px-[4vw] pt-[105px] pb-[30px] text-ink max-[800px]:min-h-[650px] max-[800px]:px-[6vw] max-[800px]:pt-20" id="contact">
      ...
      <div className="contact-box-scroll relative">
        <div className="contact-box-scene relative mt-[26px] block h-[min(67vw,680px)] min-h-[480px] w-[min(1180px,100%)] overflow-hidden rounded-t-[clamp(68px,11vw,180px)] bg-[#9cebf0] [background:radial-gradient(circle_at_8%_92%,var(--color-yellow)_0_4%,transparent_4.2%),radial-gradient(circle_at_91%_13%,var(--color-pink)_0_2.4%,transparent_2.6%),#9cebf0] max-[800px]:h-[520px] max-[800px]:min-h-[520px] max-[800px]:rounded-t-[70px]">
          <ThreeContactBox />

          <div className="contact-box-content absolute bottom-[30px] left-1/2 z-2 w-[min(560px,calc(100%_-_42px))] -translate-x-1/2 translate-y-[32px] scale-[.8] border-2 border-ink bg-paper p-[22px] opacity-0 shadow-[5px_5px_0_#090806] [transform-origin:center_bottom] transition-[opacity,transform] duration-[700ms] ease-[cubic-bezier(.2,.8,.2,1)] max-[800px]:bottom-[18px] max-[800px]:w-[calc(100%_-_28px)] max-[800px]:p-4">
            ...
            <div className="contact-links flex flex-wrap gap-[10px] max-[800px]:grid">
